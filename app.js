    ...
    card.innerHTML = `
        <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto pt-2">
                <button type="button" class="btn btn-danger btn-sm w-100" onclick="Eliminar('${persona._id}')">
    ...
    db.allDocs({ include_docs: true, descending: true }) 
        .then((response) => {
            ...
            if (response.rows.length === 0) {
                divCards.innerHTML = '<p class="text-center w-100 mt-4">No hay personas registradas</p>';
                return;
            }
        ...
        .catch((err) => {
            ...
            divCards.innerHTML = '<p class="text-danger w-100 mt-4">Error al cargar los datos.</p>';
        });
}
